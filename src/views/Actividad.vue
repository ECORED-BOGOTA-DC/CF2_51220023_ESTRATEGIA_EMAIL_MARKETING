  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Aplicación de Email Marketing como estrategia de mercadeo
        p.mb-4 Repasar conceptos relacionados con Email marketing para la definición de acciones a ejecutar en el plan estratégico de una pyme.
